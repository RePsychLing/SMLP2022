...
contrasts = Dict(
  :Match => EffectsCoding(base= "match"; levels=["match", "mismatch"]),
  :ACN   => EffectsCoding(base= "singular"; levels=["singular", "plural"]),
  :Strct => EffectsCoding(base= "without"; levels=["without", "with"]),
  :Subj  => Grouping(),
  :Item  => Grouping()
);
```
