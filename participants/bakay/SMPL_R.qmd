---
title: "Ozge Bakay: Missing Verb Illusion"
...
```{r}
df <- 
  read_excel("./data/Exp3 R Data.xlsx") |> 
#  filter(Subject != 10) |> 
  filter(Type == "exp") |> 
...
+ There are two significant main effects of Case and Gram, irrespective of the complexity of the randome-effect struture.
