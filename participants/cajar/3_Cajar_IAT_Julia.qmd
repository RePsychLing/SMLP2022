...
In this section we examine  _much under-appreciated_ information estimated in LMMs, that is predictions based on model parameters for subjects and items (i.e., units of grouping variables/levels of random factors).
