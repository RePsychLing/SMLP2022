---
title: "Anke Cajar:Borrowing Strength in IAT: No-Faking Subject"
...
summary(rePCA(m2_cpx1))
VarCorr(m2_cpx1)

m2_cpx2 <- lmer(speed ~ 1 + sw*tm*bl + (1 + sw + tm + bl + sw:bl + tm:bl | Subj) ,
                data=iat_fake, REML=FALSE, control=lmerControl(calc.derivs=FALSE))
summary(rePCA(m2_cpx2))
VarCorr(m2_cpx2)

m2_zcp <- lmer(speed ~ 1 + sw*tm*bl + (1 + sw + tm + bl + sw:bl + tm:bl || Subj) ,
               data=iat_fake, REML=FALSE, control=lmerControl(calc.derivs=FALSE))
summary(rePCA(m2_zcp))
VarCorr(m2_zcp)

anova(m2_zcp, m2_cpx2, m2_cpx1)

m2_voi <- lmer(speed ~ 1 + sw*tm*bl + (1 | Subj),
           data=iat_fake, REML=FALSE, control=lmerControl(calc.derivs=FALSE))

anova(m2_voi, m2_zcp, m2_cpx2, m2_cpx1)
```

+ Two significant interactions (sw:bl; tm:bl)
+ Significant CPs
