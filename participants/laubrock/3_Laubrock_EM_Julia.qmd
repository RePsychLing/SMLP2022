...
describe(dat)
@transform!(dat, :rfl2 = :rfl * :rfl);
@transform!(dat, :rwn2 = :rwn * :rwn);
@transform!(dat, :rwn3 = :rwn2 * :rwn);
...
```{julia}
#| lst-label: m_ovi
f1_ovi = @formula(lfd ~ 1 + lls + rfl + rfl2 + rwn + rwn2 + rwn3 +
...
```{julia}
#| lst-label: m_zcp
f1_zcp = @formula(lfd ~ 1 + lls + + rfl + rfl2 + rwn + rwn2 + rwn3 +
                        f + l + f1 + l1 + f2 + l2 + p + p1 + p2 +
...
```{julia}
#| lst-label: m_cpx
f1_cpx = @formula(lfd ~ 1 + lls + + rfl + rfl2 + rwn + rwn2 + rwn3 +
                       f + l + f1 + l1 + f2 + l2 + p + p1 + p2 +
...
```{julia}
#| lst-label: m_prsm1
f1_prsm = @formula(lfd ~ 1 + lls + + rfl + rfl2 + rwn + rwn2 + rwn3 +
                         f + l + f1 + l1 + f2 + l2 + p + p1 + p2 +
