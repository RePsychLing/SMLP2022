...
#| fig-cap: Prediction intervals of the subject random effects in model m_prsm
#| 
...
#| fig-cap: Prediction intervals of the item random effects in model m_prsm
#| 
cm_prsm = last(ranefinfo(m_prsm));
caterpillar!(Figure(; resolution=(800, 1200)), cm_prsm; orderby=1)
```
...
#| fig-cap: Shrinkage plots of the subject random effects in model m_KM
