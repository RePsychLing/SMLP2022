...
```{r} 
library(readxl) 
lang_ECG <- read.csv("./data/lang_ECG.csv", header=TRUE, sep=";", dec = ",") 
str(lang_ECG)
...
pc0 =lmer(log(LT)~Familiarity+(1|Participant), data=lang_ECG, REML=FALSE)
pc1=lmer(log(LT)~Familiarity*pc1C+(1|Participant), data=lang_ECG, REML=FALSE)
pc2=lmer(log(LT)~Familiarity*pc1C+Familiarity*pc2C+(1|Participant), data=lang_ECG, REML=FALSE)
