...
The following plot displays the data in a multi-panel plot created with the `lattice` package in `R` [@Sarkar2008], using the [RCall](https://juliahub.com/ui/Packages/RCall/8GFyb/0.13.13) package for Julia.
